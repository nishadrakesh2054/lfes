...
const processData = [
  {
    ...
    description:
      "Every child's wellbeing and growth is our top priority. We create a nurturing environment where students feel safe, valued, and supported in their educational journey.",
  },
  {
    id: 2,
    ...
    description:
      "We foster curiosity and critical thinking skills that extend beyond the classroom, empowering students to become independent, self-motivated learners for life.",
  },
  {
    id: 3,
    ...
    description:
      "We provide personalized support and resources to ensure every student receives the attention they need to overcome challenges and achieve their full potential.",
  },
];
    ...
    <section className="process-area tp-process-3-bg fix">
      <div className="container">
            ...
            <div className="tp-process-3-wrap">
              <div className="tp-section-2">
                ...
                <p>
                  ...
                  miles of child. <br /> Exercise joy man children rejoiced.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="tp-process-3-wrapper">
          <div className="row">
            {processData.map((process, index) => (
              <div className="col-lg-4" key={index}>
                <div
                  className={`tp-process-3-item tp-process-3-item-${process.id} wow fadeInUp`}
          ...
          <div
            className="tp-process-3-shape-1 wow fadeInUp"
            data-wow-delay=".5s"
          >
            <span>
              <ProcessLineSvg />
