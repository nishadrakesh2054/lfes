            ...
            <div className="col-xl-4 col-lg-3 col-sm-6">
              ...
              >
                ...
                <div className="tp-footer-widget-content">
                  <p>
                    Dedicated to providing world-class education with innovative
                    teaching methods and personalized learning experiences for
                    every student
                  </p>
                </div>
                <div className="tp-footer-contact">
                  <span>Got Questions? Call us</span>
                  <a href="tel:012345678">+(977) 023-530172</a>
                </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="tp-footer-copyright text-center">
                <span>
                  © {new Date().getFullYear()} <a href="#">LFES</a>. All rights
                  reserved.
                </span>
                <span>
