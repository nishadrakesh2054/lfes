...
export default function CampusLifeArea() {
  return (
    <section className="tp-campus-life-area p-relative  pb-210">
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <div
              className="tp-campus-life-title-wrap text-center wow fadeInUp"
              data-wow-delay=".3s"
            >
              <div className="tp-campus-choose-btn">
                <p>LIFE ON LFES SCHOOL</p>
                <a href="#down2">
                  <span>
                    <DownArrowThree />
                  </span>
              ...
              <h3 className="tp-campus-life-title">
                Together, we grow in mind, body, spirit <br />
                and character.
              </h3>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div id="down2" className="tp-campus-life-slider p-relative">
              <Swiper
                {...slider_options}
                modules={[Navigation]}
                className="tp-campus-life-active"
              >
