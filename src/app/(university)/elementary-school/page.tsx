            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6">
                <div className="px-1">
                  ...
                  >
                    At our Primary Block, we believe that every child’s journey
                    is unique and deserves careful attention. Our approach to
                    teaching is holistic—going beyond textbooks to nurture
                    creativity, critical thinking, emotional growth, and social
                    skills. We create a learning environment where curiosity is
                    celebrated, and every lesson is designed to connect with
                    real-life experiences, making learning meaningful and
                    enjoyable. <br />
                    We also understand how important it is for parents to be
                    part of this journey. That is why we make it a priority to
                    keep parents informed about even the smallest details of
                    their child’s progress. From academic achievements to
                    personal growth, every step is communicated thoughtfully,
                    ensuring that families feel connected, reassured, and
                    engaged in their child’s education. <br />
                    By focusing on the whole child—mind, heart, and spirit—we
                    aim to lay a strong foundation for lifelong learning and
                    happiness. The Primary Block is more than a place of study;
                    it is a home where children grow with confidence,
                    creativity, and care.
                  </p>
                </div>
              </div>
