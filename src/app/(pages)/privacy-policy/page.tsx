...
export default function PrivacyPolicyPage() {
  return (
    <main>
      ...
      <section
        className="tp-privacy-area pt-120 pb-120"
            ...
            <div className="col-lg-10">
              <div className="tp-privacy-box">
                <div className="tp-privacy-content">
                  ...
                  <p>
                    At Lfes, we value your privacy and are committed to
                    protecting your personal information. This Privacy Policy is
                    designed to help you understand how we collect, use,
                    disclose, and safeguard your data. By using our website or
                    services, you consent to the practices described in this
                    policy.
                  </p>
                </div>
                <div className="tp-privacy-content">
                  <h4 className="tp-privacy-content-title">
                  ...
                  <ul>
                    ...
                    <li>
                      Billing Information: Payment card details, billing
                      address.
                    </li>
                    <li>
                    ...
                    <li>
                      Cookies and Tracking Data: Data collected through cookies,
                ...
                <div className="tp-privacy-content">
                  ...
                  <ul>
                    ...
                    <li>
                      To process transactions and send transaction
                      notifications.
                    </li>
                    <li>
                ...
                <div className="tp-privacy-content">
                  ...
                  <p>
                    ...
                    information to outside parties. We may share your
                    information with trusted third parties who assist us in
                    operating our website and services, as long as they agree to
                ...
                <div className="tp-privacy-content">
                  ...
                  <p>
                    ...
                    personal information. We use encryption, secure socket layer
                    technology, and regular security audits to safeguard your
                    data.
                  </p>
                </div>
                <div className="tp-privacy-content">
                  ...
                  <p>
                    ...
                    your user experience. You can choose to disable cookies
                ...
                <div className="tp-privacy-content">
                  ...
                  <p>
                    You can choose not to provide certain information; however,
                    this may limit your access to some features of our website.
                  </p>
                </div>
                <div className="tp-privacy-content">
                  <h4 className="tp-privacy-content-title">
                  ...
                  <p>
                    ...
                    at any time. When we do, we will revise the{" "}
                    {"Effective Date"} at the beginning of this policy. We
                ...
                <div className="tp-privacy-content">
                  ...
                  <p>
                    ...
                    Policy, please contact us at support@Lfes.net
                  </p>
                </div>
                <div className="tp-privacy-content-bottom mt-30">
                  <p>
                    Last updated on October 15, 2023. ThemePure reserves the
                    right to change or modify the above contents at any time
